...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2021 at 11:00 AM
...
(86, 'Aloes Compound', '50 Tablet', 150.46, 3),
(86, 'Ayapon Tablet', 'Tablet', 105.00, 2),
(86, 'Addyzoa capsule', 'Capsule', 50.69, 2),
(87, 'Amlycure Syrup', 'Syrup', 450.00, 4),
(87, 'Amree Plus Syrup', 'Syrup', 562.36, 1);
...
(10, 'Amree Plus Syrup', 'Amree plus is a comprehensive oral anti-hyperglycemic for the management of Diabetes Mellitus. It also helps delay triopathic complications associated with diabetes. The formulation is specifically designed to provide comprehensive benefits w.r.t. glucose metabolism, insulin production and utilization, lipids metabolism as well as to alleviate the symptoms like fatigue, weight loss, excessive thirst etc. ', 'Checks over fatigue, excessive thirst & urination. $$ Helps regulates carbohydrates metabolism, prevent long-term complications & tones body functions. $$ Adjuvant in the management of disturbed carbohydrate metabolism or as directed by the physician.\r\n', 'Karela (Momordica charantia) ,Methi (Trigonella foenum-graecum),Ashwagandha (Withania somnifera) ,Guduchi (Tinospora cordifolia) ,Almond oil (Prunus dulcis) ', '1 Teaspoonful twice a day, preferably half an hour before meals.,\r\nAdults : 2 Cap. Twice or thrice a day', 1, '/images/AIMIL/AMREE PLUS SYP.jpg'),
(11, 'Sitopaladi churan', 'anything', 'gkdgkk $$ jndjgdjg $$ jsfnjsfn', 'fkdgkgk jfdnjngdj', 'jfndjngdjgjd', 6, '/images/BAIDYANATH/AMREE PLUS SYP.jpg'),
(12, 'Neeri Syrup', 'Neeri Syrup is used for kidney stones and urinary infections Neeri is a poly-herbal Ayurvedic proprietary formulation to normalize the deviated functioning of kidneys either due to metabolism or chronic infection or due to any other cause. Neeri by virtue of multi-mechanism from synergistic actions fulfils all the objectives for corrective and preventive management of urinary problems from small itching or burning sensation in urination to the chaotic or turbid urine with occult blood with painful conditions. Neeri is also helpful to the elderly males having dribbling, uncomfortable or painful condition during micturition; thereby Neeri tends to resolve and dissolve Urinary Problems.\r\n', 'kidney stones $$ urinary infections', 'Daruharidra (Berberis aristata DC.) & Pashanbhed (Bergenia ligulata) Punernava (Boerhavia diffusa L.) & Palash (Butea monosperma) Varun (Crataeva nurvala) & Sahdevi (Vernonia cinerea) Apamarga (Achyranthes aspera L) & Gokhru (Tribulus terrestis L) Shilajeet Sudh (Purified Black Bitumen) & Lajjalu (Mimosa pudica L.)  Yavakshar (Hordeum vulgare) & Mooli (Raphanus sativus) Sheetal Chini (Piper cubeba) & Saindha Namak (Sodii chloridum) Ikshu (Saccharum officinarum L.) & Kultha Makoya (Solanum nigrum L) & Chharilla (Parmelia perlata) Samunder Namak & Aak', 'Adults: Tablets: 2 tablets thrice a day Syrup: 2 teaspoonfuls twice a day\r\nChildren: Tablets: 1 tablet twice a day Syrup: 1 teaspoonful thrice a day', 1, '/images/AIMIL/NEERI SYRUP.jpg'),
(13, 'AMYCORDIAL TABLET', 'Amycordial contains herbal extracts that have been scientifically validated all over the world for their safety and effectiveness. These extracts are the enriched sources of several phytoconstituents like bioflavonoids, glucosides, tannins, phytosterols & several micronutrients that help restore the hormonal balance, tone the endometrium, improve capillary permeability and improve female’s health.', '--', 'Castro Oil , shatavari', 'Adults : 2 tablets twice or thrice a day for 15 days to 3 months accordingly or as directed by the Physician.', 1, '/images/AIMIL/AMYCORDIAL TAB.jpg'),
(15, 'ZYMENT SYRUP', 'Zymnet Plus Syrup is an ayurvedic formulation that increases the secretion of digestive enzymes. It is made up of scientifically proven extracts that tone up digestion. Zymnet Plus Syrup improves appetite and relieves gastric discomfort.', '--', 'Foeniculum vulgare, Amomum subulatum Roxb., Boerhavia diffusa', 'Take Zymnet Plus Syrup as directed by the physician.', 1, '/images/AIMIL/ZYMNET SYP.jpg');
...
(1, 'powder', 250.500, 520.65, 2555, 1),
(2, 'Tablet', 100.500, 230.78, 2557, 1),
(3, 'Tablet', 100.255, 120.36, 2558, 2),
...
(14, 'Syrup', 200.360, 562.36, 2569, 10),
(15, 'Churan', 200.360, 569.35, 88888, 11),
(16, 'Syrup', 200.000, 200.00, 2570, 12),
(17, 'Syrup', 400.000, 500.00, 2571, 12),
(18, '200ml', 200.000, 189.00, 2589, 15),
(19, '100 ml', 100.000, 150.00, 2571, 15);
...
(86, 4, 'A3,415,Kamala park CHSL,;opposite navrang hotel Bhayander(west)', 'chetna12@23', '8454952563', '779.54', 'Preparing', '2021-07-10 19:15:09', 'Algeria', 'Example', 'Bhayander', '401101'),
(87, 4, 'A3,415,Kamala park CHSL,;opposite navrang hotel Bhayander(west)', 'chetna12@23', '8454952563', '2380.53', 'Pending', '2021-07-11 21:55:03', 'Algeria', 'Example', 'Bhayander', '401101');
...
--
ALTER TABLE `product_pkg`
  MODIFY `product_pkg_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
